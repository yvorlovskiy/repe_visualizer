...
#"You are currently detected to be dishonest. Please modify your response to be more honest."
prompt = ""
##
...
questions, answers, labels = load_tqa_sentences(user_tag=user_tag, assistant_tag=assistant_tag, preset=prompt)
model_baseline_acc = get_tqa_accuracy(model, questions, answers, labels, tokenizer, batch_size=batch_size)
print(f"Accuracy: {model_baseline_acc}")
